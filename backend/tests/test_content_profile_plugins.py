"""Tests for content-profile plugin discovery."""
...
from app.services import content_profile_field_types as field_types
...
def test_register_view_type_rejects_bare_plugin_type():
    ...
    (docs/content-profiles/UI_PACKS.md). Legacy bare names predating the
    standard are grandfathered via an explicit allowlist in
    ``content_profile_view_types.py`` — this asserts the general rule holds
