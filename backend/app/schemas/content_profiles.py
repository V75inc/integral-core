"""ContentProfile Pydantic schemas."""
...
class ImportPreviewResponse(BaseModel):
    """Response contract for POST /content-profiles/import?preview=true.
    ...
    ``"archive"`` for ZIP uploads containing one or more ``profile.yaml``
    bundles.
    """
