...
async def _connected_sources_doc(
    ...
    Lists the canonical slug keys (``mcp__<slug>__<tool>``) — the
    ...
    return OverlaySkillDoc(
        ...
        description=(
            "External data sources connected to this workspace and the exact tools that reach them."
        ),
        body=body,
        requires_tools=(),
        metadata={"kind": "connected_sources"},
    )
