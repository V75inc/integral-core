...
``package.name``) from seeded library OperationalModels — not a hardcoded
...
async def author_operational_model_from_template(
    *,
    description: str,
    target_scope: str,
...
__all__ = ["DOMAIN_KEYWORD_MAP", "author_operational_model_from_template"]
