...
Route awareness lives in jvagent SESSION CONTEXT (ADR-0056) via
``visitor.data["page_context"]``. This module no longer builds utterance
preambles — only delimiters for other injected blocks, sanitization, the
on-demand tool, and lightweight message metadata.
"""
