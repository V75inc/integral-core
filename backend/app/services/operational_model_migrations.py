"""Declarative migration runner for OperationalModel publish events.
...
async def _affected_tracks(published_cp: OperationalModel) -> List[Track]:
    """Find every Track whose published-side schema is the published_cp.

    For track-attached operational models this is the singleton owner. For
    app-attached operational models, it's every Track inside the owning App.
    """
