...
.PHONY: help verify verify-pr verify-ci verify-core-only verify-contract verify-artifact verify-clean-install verify-sdk-artifact test-backend test-frontend test-postgres test-postgres-ci types lint guards \
