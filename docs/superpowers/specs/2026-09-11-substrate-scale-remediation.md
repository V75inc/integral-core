...
**Files:** `models/nodes.py`, `services/pagination.py`, `services/entry_search.py`, `services/entry_listing.py`, `services/db_init.py`, `main.py` (`_ensure_model_indexes`), `docs/backend/operational-model-search-index.md`.
