...
Strategic product docs for Integral — vision, requirements, architecture, roadmap, and BYOA.

| Doc | Purpose |
|-----|---------|
| [CONCEPT.md](CONCEPT.md) | Product vision and philosophy |
| [PRD.md](PRD.md) | Requirements, personas, epics |
| [ARCHITECTURE.md](ARCHITECTURE.md) | System design, data model, APIs, access model (§9) |
